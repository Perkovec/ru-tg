...
function signIn() {
  return new Promise((resolve, reject) => {
    ...
    userData = UserData.loadUser();
    ui.spacer();
    var authKeyBuffer = userData.getAuthKey();
    clientProxy.setAuthKey(authKeyBuffer, "");
    clientProxy.createClientForUser(userData.getDataCenter()).then(resolve, reject);
  });
}

function signInn(users) {
